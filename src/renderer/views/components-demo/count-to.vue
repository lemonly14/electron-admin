  ...
  <div class="components-container">
    <aside>
      <a
        ...
        target="_blank">countTo-component</a>
    </aside>
    <count-to
      ref="example"
      :start-val="_startVal"
