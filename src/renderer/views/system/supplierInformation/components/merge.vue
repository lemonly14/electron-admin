    ...
    <el-dialog :visible.sync="isShow">
      ...
      <span slot="footer">
        ...
        <el-button type="primary"
                   @click="submitForm('supplierInfoFrom')">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
  ...
  watch: {
    editInfo: {
      handler(newInfo, oldInfo) {
        this.supplierInfoFrom = _.cloneDeep(newInfo)
    ...
    isShow(newVal, oldVal) {
      newVal && this.tittleName === '添加' && Object.keys(this.supplierInfoFrom).forEach(key => { this.supplierInfoFrom[key] = '' })
      this.$nextTick(() => {
        this.$refs.supplierInfoFrom.clearValidate()
      })
    }
  },
