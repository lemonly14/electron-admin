    ...
    <el-tabs
      ...
      <el-tab-pane
        ...
        <el-form-item label="条形码信息">
          <el-input
            v-model="currentComponent.props.data"
            class="w-100"
            size="small"
            @input="handleUpdateBarcodeData(currentComponent.props.data)" />
        </el-form-item>
        <el-form-item label="条形码格式">
          <el-select
            v-model="currentComponent.props.format"
            class="w-100"
            size="small"
            filterable
        ...
        <el-form-item label="是否显示值">
          <el-select
            v-model="currentComponent.props.displayValue"
            class="w-100"
            size="small"
            filterable
            @change="debounceUpdate">
      ...
      <el-tab-pane
        ...
        <el-form-item label="线宽">
          <el-input-number
            v-model="currentComponent.props.lineWidth"
            class="w-100"
            :min="1"
            :max="10"
            label="描述文字"
        ...
        <el-form-item label="字体大小">
          <el-select
            v-model="currentComponent.props.fontSize"
            class="w-100"
            size="small"
            @change="debounceUpdate">
            <el-option
        ...
        <el-form-item label="条形码高度">
          <el-input-number
            v-model="currentComponent.props.bodyHeight"
            class="w-100"
            :min="1"
            :max="100"
            label="描述文字"
