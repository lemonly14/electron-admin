      ...
      <el-tab-pane
        ...
        <el-form ref="content-form">
          <el-form-item label="文本内容">
            <el-input
              v-model="currentComponent.props.text"
              type="textarea"
              :rows="4"
              resize="none"
              size="small" />
          ...
          <el-form-item label="对齐方式">
            <el-select
              v-model="currentComponent.props.align"
              class="w-100"
              size="small">
              <el-option
          ...
          <el-form-item label="字体类型">
            <el-select
              v-model="currentComponent.props.fontFamily"
              class="w-100"
              size="small">
              <el-option
          ...
          <el-form-item label="文本行距">
            <el-select
              v-model="currentComponent.props.lineHeight"
              class="w-100"
              size="small">
              <el-option
